...
public class UserDefinedDataTypesTest extends AbstractCassandraBasedTest {
    ...
    public void testSimpleTable() throws Exception {
        ...
        customersDao.writeWithKey(CustomersTable.ID, "95453543534")
                    ...
                    .value(CustomersTable.CURRENT_ADDRESS, new Address(ImmutableList.of(new Addressline("brauerstrasse")), 76336, ImmutableMap.of("a1", new Addressline("alias1"))))
                    .value(CustomersTable.OLD_ADDRESSES, ImmutableSet.of(new Address(ImmutableList.of(new Addressline("frankfurter ring")), 80445, ImmutableMap.of("a2", new Addressline("alias2")))))
