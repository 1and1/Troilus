...
class ReadQueryDataImpl implements ReadQueryData {
     ...
     */
    static CompletableFuture<Statement> toStatementAsync(ReadQueryData data, UDTValueMapper udtValueMapper, DBSession dbSession) {
        ...
        // key-based selection    
            ...
            return dbSession.prepareAsync(select)
