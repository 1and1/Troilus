...
public interface Dao {
    ...
    ListReadWithUnit<RecordList> readSequenceWithKeys(String name, ImmutableList<Object> values);

    ListReadWithUnit<RecordList> readSequenceWithKeys(String composedKeyNamePart1, Object composedKeyValuePart1, 
    ...
    <T> ListReadWithUnit<RecordList> readSequenceWithKeys(ColumnName<T> name, ImmutableList<T> values);

    <T, E> ListReadWithUnit<RecordList> readSequenceWithKeys(ColumnName<T> composedKeyNamePart1, T composedKeyValuePart1, 
                                                             ColumnName<E> composedKeyNamePart2, ImmutableList<E> composedKeyValuesPart2);

    <T, E, F> ListReadWithUnit<RecordList> readSequenceWithKeys(ColumnName<T> composedKeyNamePart1, T composedKeyValuePart1, 
                                                                ColumnName<E> composedKeyNamePart2, E composedKeyValuePart2,
