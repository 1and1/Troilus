...
public class EntityMappingTest  {
    ...
    public void testUserObject() throws Exception {
        ...
        ////////////////
        // inserts
        userDao.writeEntity(new User("67454545", "paul", true, ByteBuffer.wrap(new byte[] { 6, 7, 8}), new byte[] { 5, 7, 8, 5}, new Date(1345553l), ImmutableSet.of("12313241243", "232323"), ImmutableList.of("berlin", "budapest")))
               .ifNotExists()
               .execute();
        ...
        Assert.assertNotNull(record.getTimestamp("modified"));
        ...
        Assert.assertEquals(1345553, user.getTimestamp(UsersTable.MODIFIED).getTime());
        
        
        
        ////////////////
        // update
        userDao.writeEntity(new User("67454545", null, true, ByteBuffer.wrap(new byte[] { 6, 7, 8}), new byte[] { 5, 7, 8, 5}, new Date(1345553l), ImmutableSet.of("12313241243", "232323"), ImmutableList.of()))
               .execute();
        ...
        userDao.writeWithKey("user_id", "568785563")
               .entity(new MinimalUser("paul", true, ByteBuffer.wrap(new byte[] { 6, 7, 8}), new byte[] { 5, 7, 8, 5}, new Date(1345553l), ImmutableSet.of("12313241243", "232323"), ImmutableList.of("berlin", "budapest")))
               .execute();
        ...
        userDao.writeEntity(new User("435675743", "bertra", true, ByteBuffer.wrap(new byte[] { 6, 7, 8}), null, new Date(1345553l), ImmutableSet.of("12313241243", "232323"), ImmutableList.of("berlin", "budapest")))
               .ifNotExists()
               .execute();
        ...
        userDao.writeEntity(new User("232443443", "paul", true, ByteBuffer.wrap(new byte[] { 6, 7, 8}), new byte[] { 5, 7, 8, 5}, new Date(1345553l), ImmutableSet.of("12313241243", "232323"), ImmutableList.of("berlin", "budapest")))
               .ifNotExists()
